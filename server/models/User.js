		...
		bcrypt.genSalt(saltRounds, function (err, salt) {
			...
			bcrypt.hash(user.password, salt, async function (err, hash) {
				...
				if (user.token_mail == false) {
					...
					console.log(accessToken, 22222222);
					let transporter = nodemailer.createTransport({
						service: "gmail",
						auth: {
							type: "OAuth2",
							user: "annagasparyan01@gmail.com", // generated user
							clientId:
								"403415662178-0tl93d1j1d5ah961pakasvqs75vsj3i9.apps.googleusercontent.com",
							clientSecret: "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",
